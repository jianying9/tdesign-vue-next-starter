...
import { createGraphOption } from '@/utils/charts';
...
echarts.use([GraphChart, CanvasRenderer, TooltipComponent, ToolboxComponent]);
...
const renderMonitorChart = async () => {
  const option = createGraphOption(props.data);
