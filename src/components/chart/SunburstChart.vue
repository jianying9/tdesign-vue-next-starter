...
import { createSunburstOption } from '@/utils/charts';
...
echarts.use([TooltipComponent, LegendComponent, SunburstChart, CanvasRenderer, ToolboxComponent]);
...
const renderMonitorChart = async () => {
  const option = createSunburstOption(props.data, props.formatter);
