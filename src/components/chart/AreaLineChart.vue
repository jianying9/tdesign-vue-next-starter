...
import { createAreaLineOption } from '@/utils/charts';
...
echarts.use([TooltipComponent, LegendComponent, GridComponent, LineChart, BarChart, CanvasRenderer, ToolboxComponent]);
